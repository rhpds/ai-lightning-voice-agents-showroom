...
1. Complete the **Models** notebook first (speech models must be running)
2. Open a **Terminal** in JupyterLab and log in to OpenShift:
...
https://github.com/eformat/voice-agents/blob/main/content/notebooks/2-pizza-shop.ipynb[2-pizza-shop.ipynb^]
...
[NOTE]
====
The MaaS LLM token requires your personal service account from the enterprise tier namespace. The notebook will prompt you to fill in your SA name. Run `oc get sa -n maas-default-gateway-tier-enterprise` to find it.
====
